...
mod tests {
    ...
    fn update_state_signs() -> String {
        ...
        hash_and_sign(&keypair_0.secret(), &[&update_state])
    }

    #[test]
    fn test_hash_and_sign() {
        let update_state_sign_val = "0xc668d80913a092307a51da6ce1c15cdf1e1d15821c6cdd3fcfa7e176571829b02232381c31db720e5cee2333bc13cb9bd76785841eeb428dfeff371a82def39401";
        assert_eq!(update_state_signs(), update_state_sign_val);
    }
}
